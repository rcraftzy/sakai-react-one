...
export const AppConfig = (props) => {
  const { setLayoutColorMode } = useUI()
  ...
  useEffect(() => {
    ...
    console.log(themeHref, themeElement)
      ...
      <div className='layout-config-content'>
        ...
        <div className='grid free-themes'>
          ...
          <div className='col-3 text-center'>
            <button
              className='p-link'
              onClick={() => changeTheme('vela-blue', 'dim')}
            >
              <img
          ...
          <div className='col-3 text-center'>
            <button
              className='p-link'
              onClick={() => changeTheme('vela-green', 'dim')}
            >
              <img
          ...
          <div className='col-3 text-center'>
            <button
              className='p-link'
              onClick={() => changeTheme('vela-orange', 'dim')}
            >
              <img
          ...
          <div className='col-3 text-center'>
            <button
              className='p-link'
              onClick={() => changeTheme('vela-purple', 'dim')}
            >
              <img
