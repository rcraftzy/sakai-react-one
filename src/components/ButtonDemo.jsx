  ...
  return (
    <div className='grid'>
      <div className='col-12 md:col-6'>
        <div className='card'>
          <h5>Default</h5>
          <Button label='Submit' className='mr-2 mb-2' />
          <Button label='Disabled' className='mr-2 mb-2' disabled />
          <Button label='Link' className='p-button-link mb-2 mr-2' />
        </div>
      ...
      <div className='col-12 md:col-6'>
        <div className='card'>
          <h5>Icons</h5>
          <Button icon='pi pi-star-fill' className='mr-2 mb-2' />
          <Button
            label='Bookmark'
            icon='pi pi-bookmark'
            className='mr-2 mb-2'
